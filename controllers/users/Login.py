...
from aurora.security import request, login_abort, check_password, set_session, set_cookie
...
class Login(Controller):
    ...
    def get(self):
        ...
        return View('login', consts=self.consts, LANGUAGE=self.LANGUAGE, form=form, next=next)
